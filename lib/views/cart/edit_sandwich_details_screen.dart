...
class EditSandwichDetailsScreen extends StatelessWidget {
  const EditSandwichDetailsScreen({super.key});
                              ...
                              Expanded(
                                child: PrimaryButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    cubit.updateDatabaseItem(
                                        productId: sandwich.id.toString(),
                                        id: cubit.selectedItemId,
                                        name: sandwich.name,
